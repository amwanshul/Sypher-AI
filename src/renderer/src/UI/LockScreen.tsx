      ...
      try {
        ...
        if (detection) {
          ...
          if (isFaceSetup) {
            ...
            await window.electron.ipcRenderer.invoke('setup-vault-face', {
              descriptor: descriptorArray,
              name: localStorage.getItem('iris_user_name') || 'Primary Identity',
              facePreview: captureFacePreview()
            })
    ...
    >
      ...
      <div className="absolute bottom-6 flex flex-col items-center gap-1 z-50">
        <span className="text-[9px] font-mono tracking-widest text-zinc-600 uppercase">
          SYPHER Kernel Security Engine V3.5
        </span>
