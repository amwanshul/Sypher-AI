...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-emerald-50 font-sans flex items-center justify-center p-4 lg:p-8 relative overflow-hidden selection:bg-emerald-500/30 selection:text-emerald-100">
      ...
      <div className="w-full max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="hidden lg:flex col-span-3 flex-col h-125 bg-black/40 backdrop-blur-md border border-white/5 rounded-2xl p-5 shadow-2xl relative overflow-hidden">
        ...
        <div className="col-span-1 lg:col-span-6 flex flex-col items-center justify-center">
          <div className="text-center mb-10 flex flex-col items-center">
            ...
            <h1 className="text-4xl font-black tracking-[0.2em] uppercase text-white mb-2 drop-shadow-md">
              SYPHER <span className="text-emerald-500">OS</span>
            </h1>
        ...
        <div className="hidden lg:flex col-span-3 flex-col h-125 bg-black/40 backdrop-blur-md border border-white/5 rounded-2xl p-5 shadow-2xl">
          ...
          <div className="mt-auto p-4 bg-emerald-900/10 border border-emerald-500/20 rounded-xl">
            <p className="text-[9px] text-emerald-400/80 tracking-widest uppercase leading-relaxed">
              SYPHER OS Operates strictly within local environments. External pings are limited to
